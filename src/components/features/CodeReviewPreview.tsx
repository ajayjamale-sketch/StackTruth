        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="px-5 py-4 border-b border-border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-2xl font-bold text-primary">
                    74<span className="text-sm text-muted-foreground">/100</span>
                  </span>
                </div>
              ...
              <div className="divide-y divide-border" role="list">
                {reviewItems.map((item) => {
                  ...
                  return (
                    <div key={item.line} className="flex gap-3 p-4 hover:bg-muted/30 transition-colors" role="listitem">
                      <div
          ...
          <div className="order-1 lg:order-2">
            ...
            <Button asChild className="bg-primary hover:bg-primary/90">
              <Link to="/code-review">
                Try Code Review <ArrowRight className="w-4 h-4 ml-2" aria-hidden="true" />
              </Link>
            </Button>
          </div>
        </div>
