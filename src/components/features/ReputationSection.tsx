      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            ...
            <br />
            <span className="text-gradient">quality contributions</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-1 mt-1">
                      {dev.skills.map(skill => (
                        <span key={skill} className="text-[10px] px-1.5 bg-primary/10 text-primary rounded">
                          {skill}
                        </span>
                      ))}
                    </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {badges.map(badge => {
                ...
                return (
                  <div
                    key={badge.name}
                    className={`border ${badge.color} rounded-xl p-4 flex items-center gap-3`}
                  >
            ...
            <div className="bg-card border border-border rounded-xl p-4 mb-6">
              ...
              <div
                className="h-2 bg-muted rounded-full mb-1"
                role="progressbar"
                aria-label="Reputation progress to Expert status"
                aria-valuenow={62}
                aria-valuemin={0}
                aria-valuemax={100}
              >
            ...
            <Button asChild className="bg-primary hover:bg-primary/90">
              <Link to="/leaderboard">
                View Leaderboard <ArrowRight className="w-4 h-4 ml-2" aria-hidden="true" />
              </Link>
            </Button>
          </div>
        </div>
