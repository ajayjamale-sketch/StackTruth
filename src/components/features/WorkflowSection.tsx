...
import { ArrowRight, Search, Zap, FileText, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            A structured, AI-enhanced workflow that ensures every question gets a quality-validated, expert-reviewed answer.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div
            className="absolute top-8 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-primary/0 via-primary/30 to-primary/0 hidden lg:block"
            aria-hidden="true"
          />
          ...
          {workflows.map((workflow, idx) => {
            ...
            return (
              <div key={workflow.step} className="relative text-center">
                <div className="w-16 h-16 rounded-2xl bg-card border border-border mx-auto mb-5 flex items-center justify-center relative z-10">
                  <Icon className={`w-7 h-7 ${workflow.color}`} aria-hidden="true" />
                  <span
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">{workflow.desc}</p>
              </div>
            );
          })}
        </div>
        ...
        <div className="text-center mt-10">
          <Button asChild className="bg-primary hover:bg-primary/90">
            <Link to="/questions/ask">
              Ask Your First Question <ArrowRight className="w-4 h-4 ml-2" aria-hidden="true" />
            </Link>
          </Button>
        </div>
      </div>
