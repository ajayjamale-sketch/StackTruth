...
// Type definition for policy sections
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 p-5 bg-muted/30 rounded-xl text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Link to="/contact" className="text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary rounded">
                  Contact our privacy team
                </Link>
                {' '}or email{' '}
                <a
                  href="mailto:privacy@stacktruth.dev"
                  className="text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary rounded"
                >
                  privacy@stacktruth.dev
                </a>
              </p>
            </div>
          </div>
