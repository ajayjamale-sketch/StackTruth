    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 section-dark relative overflow-hidden dark">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <Badge className="mb-4 bg-primary/20 text-blue-300 border border-primary/30">We're Hiring</Badge>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-5">Build the future of developer knowledge</h1>
          <p className="text-xl text-slate-200/80 max-w-2xl mx-auto">We are a small, high-impact team building tools that millions of engineers use every day.</p>
        </div>
      </section>
