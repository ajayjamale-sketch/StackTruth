    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-12">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6 pb-6 border-b border-border">
          ...
          <span className="flex items-center gap-1">
            <Heart className={`w-3.5 h-3.5 ${liked ? 'fill-red-500 text-red-500' : 'text-red-600 dark:text-red-400'}`} />
            {likes} likes
          </span>
          <button
        ...
        <div className="prose prose-sm max-w-none">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Building production-grade software requires deep knowledge of your
            technology stack. In this article, we'll dive into advanced patterns
            and best practices that senior engineers use to write maintainable,
            performant, and secure code.
          </p>

          <h2 className="text-xl font-bold mt-8 mb-3">Core Concepts</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            Understanding the fundamentals is critical before diving into advanced
            patterns. We'll cover the core concepts that form the foundation of
          ...
          <div className="bg-muted rounded-xl p-5 font-mono text-xs my-6 overflow-x-auto">
            ...
            <p>
              ...
              <span className="text-white">optimizedQuery</span>{' '}
              <span className="text-muted-foreground">= async (</span>
              <span className="text-yellow-600 dark:text-yellow-400">params</span>
              <span className="text-muted-foreground">: QueryParams</span>
            ...
            <p className="pl-4">
              ...
              <span className="text-green-600 dark:text-green-400">cache.get</span>
            ...
            <p className="pl-4">
              ...
              <span className="text-muted-foreground">= await</span>{' '}
              <span className="text-green-600 dark:text-green-400">db.query</span>
              <span className="text-muted-foreground">(params.sql, params.values);</span>
            </p>
            <p className="pl-4">
              <span className="text-muted-foreground">await</span>{' '}
              <span className="text-green-600 dark:text-green-400">cache.set</span>
              <span className="text-muted-foreground">(params.key, result, 300);</span>
            </p>
            <p className="pl-4">
              <span className="text-purple-600 dark:text-purple-400">return</span>{' '}
              <span className="text-white">result</span>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            After years of production deployments and thousands of code reviews,
            these are the patterns that consistently lead to better outcomes in
            high-scale systems.
          </p>

          <h2 className="text-xl font-bold mt-8 mb-3">Conclusion</h2>
          <p className="text-muted-foreground leading-relaxed">
            The patterns covered in this article have been battle-tested in
            production environments handling millions of requests per day. Apply
            them thoughtfully and always measure before optimizing.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {mockBlogs
              ...
              .map(related => (
                ...
                >
                  <h4 className="font-medium text-sm mb-1.5 hover:text-primary transition-colors line-clamp-2">
                    {related.title}
                  </h4>
