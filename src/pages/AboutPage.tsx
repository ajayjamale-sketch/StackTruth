    ...
    <>
      ...
      <section className="py-24 mesh-bg text-center">
        <div className="max-w-4xl mx-auto px-6">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-sm px-4 py-1.5 text-sm text-blue-400 mb-8">
            <Zap className="w-3.5 h-3.5" /> Our Mission
          </div>
          <h1 className="text-5xl sm:text-6xl font-extrabold text-slate-950 dark:text-white mb-6 leading-tight">
      ...
      {/* Stats */}
      <section className="py-16 border-y border-border bg-slate-50/50 dark:bg-slate-950/50">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label}>
              <p className="text-4xl font-extrabold text-slate-950 dark:text-white">{stat.value}</p>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-extrabold text-slate-950 dark:text-white text-center mb-16">Our Values</h2>
      ...
      {/* Team */}
      <section className="py-24 bg-slate-50/50 dark:bg-slate-950/50 border-y border-border">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-extrabold text-slate-950 dark:text-white text-center mb-4">The Team</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TEAM.map(member => (
              <div key={member.name} className="glass-card p-5 text-center space-y-3">
                <img src={member.avatar} alt={member.name} className="w-20 h-20 rounded-xl bg-slate-100 dark:bg-slate-800 mx-auto" />
                <div>
                  <h3 className="font-bold text-slate-950 dark:text-white">{member.name}</h3>
      ...
      <section className="py-24 text-center">
        <div className="max-w-2xl mx-auto px-6 space-y-6">
          <h2 className="text-4xl font-extrabold text-slate-950 dark:text-white">Join us on this journey</h2>
