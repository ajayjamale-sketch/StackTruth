...
import { Code2, Github, Eye, EyeOff, ArrowRight, Loader2, Zap, Shield, Star, Briefcase } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-y-auto">
        <div className="flex items-center justify-between p-6">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <Button variant="ghost" size="sm" asChild><Link to="/register">Create account</Link></Button>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
                ...
                {devAccounts.map(acc => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(`flex items-center gap-2 p-2.5 rounded-lg border text-left transition-all ${acc.bg}`, bypassLoading === acc.label && 'opacity-70')}
                    >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <Input type="email" placeholder="you@company.com" {...register('email')} className={errors.email ? 'border-destructive' : ''} />
              ...
              <div>
                ...
                <div className="relative">
                  <Input type={showPwd ? 'text' : 'password'} placeholder="••••••••" {...register('password')} className="pr-10" />
